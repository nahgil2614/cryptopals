...
def main():
    ...
    p = 0xe27ee9f7dccc90b501624a1de7f2b467
    q = 0xae919136b749a228513c7392d6d2a21d
    ...
    while 1:
        ...
        if i == 1:
            s = int((Decimal(n) / (Decimal(3) * Decimal(B))).quantize(Decimal('1.'), rounding=ROUND_UP))
    ...
    print('restored message: ' + str(int2bytes_(m_calc)))
    print(m_calc == m)
